...
//
//   - pkg/reader/orga    — Ingenico/Worldline ORGA 9xx over CDC-ACM/T=1.
//     Multi-slot. Discovered via /dev/cu.usbmodem*.
//   - pkg/reader/generic — Any CCID/PC/SC reader (Cherry ST-2100,
//     OMNIKEY 3121, REINER cyberJack, …). Single-slot per reader. Routed
//     through PC/SC.
//
// Higher-level protocol code (pkg/egk, the future C2C handshake) takes
...
func (s *orgaSession) Identify() DeviceInfo {
	return orgaDeviceInfo(s.dev, s.t)
}
